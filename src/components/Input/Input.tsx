...
const Input = forwardRef<HTMLInputElement | HTMLTextAreaElement, InputProps>(function Input(
  ...
  const focusedStyle =
    'hover:border-neutral-10 hover:bg-purple-light hover:text-gray-black focus:border-primary-500 focus:text-gray-black';
  const variantStyles = {
    default: 'border-neutral-10 text-gray-dark',
    error: 'border-system-warning bg-red-light text-gray-black',
  };
