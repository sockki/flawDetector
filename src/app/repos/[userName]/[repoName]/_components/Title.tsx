...
export function Title() {
  ...
  const titleStyles =
    'h-[7.9rem] max-w-[166.4rem] min-w-[118rem] flex items-center gap-[2.4rem] rounded-full border-[0.4rem] border-primary-500 bg-white p-[2rem] text-[4rem] text-primary-500';
  return (
