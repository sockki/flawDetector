...
export default function Introduction() {
  return (
    <section
      className="relative flex w-full items-center justify-between overflow-hidden bg-primary-50 p-[27.5rem_19.2rem]"
      style={{ height: '102.2rem' }}
    >
      ...
      <div
        className="z-10 flex w-fit items-center justify-center rounded-[0.8rem] bg-white p-[9.3rem_9.5rem] shadow-[0_6.0rem_6rem_-2.4rem_rgba(97,0,255,0.25)]"
